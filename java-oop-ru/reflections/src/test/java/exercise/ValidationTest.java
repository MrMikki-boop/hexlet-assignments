...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        assertThat(result2).containsOnlyKeys("country").containsValue(List.of("can not be null"));

        Address address3 = new Address("USA", null, null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        assertThat(result3).containsOnlyKeys("city", "street", "houseNumber").containsValue(List.of("can not be null"));
    }
    // END
}
